...
Load aidlc-delivery-agent persona from `agents/aidlc-delivery-agent.md` and knowledge from `.codex/knowledge/aidlc-delivery-agent/`.
...
`bun .codex/tools/aidlc-orchestrate.ts report --stage approval-handoff --result <outcome>`.
