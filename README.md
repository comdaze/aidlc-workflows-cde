...
![version](https://img.shields.io/badge/version-2.3.18-blue)
...
- **[Customer-delivery PoC accelerator](plugins/poc-accelerator/README.md)** — optional eight-step, CDK-first plugin for a customer demo, deployment evidence, and handoff without changing the throwaway core `poc` scope
