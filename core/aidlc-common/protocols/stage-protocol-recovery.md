...
- Load `{{HARNESS_DIR}}/rules/aidlc-team.md` if affirmation already happened (re-run pre-fill from prior affirmed sections)
- Load `{{HARNESS_DIR}}/rules/aidlc-org.md` for greenfield default suggestions
